...
<script>
	...
	function addManagementData() {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/updateTrainingManagement/" + modifiedmanagementcode,
			data : {
			...
			success : function(response) {
				...
				window.location.href = "${pageContext.request.contextPath}/TrainingManagement.jsp";
	...
	function editManagement(managementcode) {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/getbymanagementCodeid/" + managementcode,
