...
<script>
	...
	function editVenue(trainingId, venueId) {
		if (venueId && trainingId) {
			$.ajax({
				type : "GET",
				url : "${pageContext.request.contextPath}/api/fetchScheduledTrainingById/" + trainingId
	...
	function updateScheduledData() {
	    if (validateForm()) {
	        ...
	        $.ajax({
	            type: "PUT",
	            url: "${pageContext.request.contextPath}/api/updateScheduledTraining/" + modifiedTid + "/" + modifiedVid,
	            contentType: "application/json",
	            data: JSON.stringify(modifiedData),
	            success: function (response) {
	            	console.log(response);
	                alert(" Scheduled Training Updated Successfully");
	                window.location.href = "${pageContext.request.contextPath}/viewTrainings.jsp";
	            },
	            error: function (xhr, status, error) {
	                console.error("Failed to update venue: " + error);
	                alert("Failed to update Scheduled Training: " + error);
	            }
	        });
	    }
	    else{
