...
<body>
    ...
    <div class="card mt-2" style="width: 100%;">
        <div class="card-body">
            <h3 class="text-center" id="trainingName"></h3><br>
            <h3 class="text-center" id="vebueName"></h3><br>
...
<!--                             <th>Action</th> -->
    ...
    <script>
        var trainingMappingBudgetArray = []; // Define the variable
...
//                     + ")'>Edit</button> </td>");
        ...
        function approveTraining() {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/api/mapping/updateMapping/" + trainingId + "/" + venueId,
