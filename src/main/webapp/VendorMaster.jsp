...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewVendor.jsp" class="btn btn-success mt-2">Add New
		Vendor +</a>
	...
	<script>
		...
		function deleteTraining(button,sl) {
			...
			$.ajax({
				type : "Delete",
				url : "${pageContext.request.contextPath}/api/vender/delete/" + sl,
		...
		function editTraining(sl) {
			...
			var editUrl = "${pageContext.request.contextPath}/EditVendorMaster.jsp?sl=" + sl;// Redirect to the EditTraining.jsp page with the query string parameters
