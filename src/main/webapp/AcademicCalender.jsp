...
<!--     <button onclick="uploadFile()">Upload File</button> -->
 <div class="row">
    ...
    <div class="col-md-4">
            <a href="${pageContext.request.contextPath}/Academic_calender_master.xlsx" download class="btn btn-info mt-2" style="margin-left: -150px; margin-top: 20px;">Download Template</a>
        </div>
    <div class="col-md-4" >
        <div class="form-group" > 
