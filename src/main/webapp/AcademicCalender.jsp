...
<!--     <button onclick="uploadFile()">Upload File</button> -->
 <div class="row">
    ...
    <div class="col-md-4">
            <a href="${pageContext.request.contextPath}/Academic_calender_master.xlsx" download class="btn btn-info mt-2" style="margin-left: -150px; margin-top: 20px;">Download Excel Format</a>
        </div>
    <div class="col-md-4" >
        <div class="form-group" > 
...
<script>
    ...
    function editTraining(training) {
        ...
        function deleteTraining(refplannerid) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/api/deactivate/" + refplannerid,
                success: function (response) {
