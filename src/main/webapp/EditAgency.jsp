...
<script>
	...
	function editagency(slno) {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/getbyid/" + slno,
	...
	function saveGradeData(slno) {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/update/" + slno,
			data : {
				agency : $("#agency").val()
			},
			success : function(response) {
				...
				window.location.href = "${pageContext.request.contextPath}/AgencyMaster.jsp";
