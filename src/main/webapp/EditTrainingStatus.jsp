	...
	$(document).ready(function() {
		...
		function editStatusCode(statuscode) {
			...
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/api/getStatusCodeByid/" + statuscode,
		...
		function saveData(statuscode) {
			...
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/api/updateTrainingStatus/" + modifiedUid,
				data : {
				...
				success : function(response) {
					...
					window.location.href = "${pageContext.request.contextPath}/TrainingStatus.jsp";
