...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewComponent.jsp" class="btn btn-success mt-2">Add New
		Component +</a>
	...
	<script>
		...
		function fetchDataAndDisplay() {
			$.ajax({
				type : "GET",
				url : "${pageContext.request.contextPath}/api/component/getall",
				dataType : "json",
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.append("<td>" + training.resources + "</td>");
		...
		function deleteTraining(button, sl) {
			...
			$.ajax({
				type : "Delete",
				url : "${pageContext.request.contextPath}/api/component/delete/" + sl,
		...
		function editTraining(id) {
			...
			if (isConfirmed) {
				...
				var editUrl = "${pageContext.request.contextPath}/EditComponentMaster.jsp?sl=" + id;// Redirect to the EditTraining.jsp page with the query string parameters
