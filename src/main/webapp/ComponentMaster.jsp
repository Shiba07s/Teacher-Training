...
<body>
	...
	<a href="/AddNewComponent.jsp" class="btn btn-success mt-2">Add New
		Component +</a>
	...
	<script>
		...
		function editTraining(id) {
			...
			if (isConfirmed) {
				...
				var editUrl = "/EditComponentMaster.jsp?sl=" + id;// Redirect to the EditTraining.jsp page with the query string parameters
