	...
	<script>
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.append("<td>" + training.tccode + "</td>");
		...
		function editTraining(id) {
			...
			if (isConfirmed) {
				...
				var editUrl = "/EditHeadMaster.jsp?sl=" + id;// Redirect to the EditTraining.jsp page with the query string parameters
