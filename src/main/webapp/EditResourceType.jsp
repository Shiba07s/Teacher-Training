...
<script>
	...
	function addResourseData() {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/updateResourceType/" + modifiedresourcecode,
			data : {
			...
			success : function(response) {
				...
				window.location.href = "${pageContext.request.contextPath}/ResourceType.jsp";
	...
	function editResource(resourcecode) {
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/getReesourceCodeByid/" + resourcecode,
...
<body>
	<div class="container" align="center">
		<h1>Edit Resourse Type</h1>
		<form class="text-left" id="addGradeForm"
			onsubmit="return submitForm()">
			<div class="form-row">
				<div class="col">
					<div class="form-group row">
						<label for="resourcecode" class="col-sm-4 col-form-label">Resource
							Type Code:</label>
						<div class="col-sm-8">
				...
				<div class="col">
					<div class="form-group row">
						<label for="resourcetype" class="col-sm-4 col-form-label">Resource
							Type:</label>
						<div class="col-sm-8">
