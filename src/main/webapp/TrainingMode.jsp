...
<body>
	...
	<a href="/AddNewTrainingMode.jsp" class="btn btn-success mt-2">Add
		New Training Mode +</a>
	...
	<script>
		...
		function deleteTraining(button, trainingModecode) {
			...
			if (isConfirmed) {
				...
				$.ajax({
					type : "Delete",
					url : "/api/deleteTrainingMode/" + trainingModecode,
		...
		function editTraining(trainingModecode) {
			...
			if (isConfirmed) {
				...
				var editUrl = "EditTrainingMode.jsp?trainingModecode="
						+ trainingModecode;
