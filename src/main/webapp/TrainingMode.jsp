...
<title>Set up for trainingMode</title>
<!-- Favicon-->
<!-- Include jQuery -->
...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewTrainingMode.jsp" class="btn btn-success mt-2">Add
		New Training Mode +</a>
	...
	<script>
		...
		function deleteTraining(button, trainingModecode) {
			...
			if (isConfirmed) {
				...
				$.ajax({
					type : "Delete",
					url : "${pageContext.request.contextPath}/api/deleteTrainingMode/" + trainingModecode,
		...
		function editTraining(trainingModecode) {
			...
			if (isConfirmed) {
				...
				var editUrl = "${pageContext.request.contextPath}/EditTrainingMode.jsp?trainingModecode="
						+ trainingModecode;
