...
<body>
	...
	<a href="/AddNewManagement.jsp" class="btn btn-success mt-2">Add
		New Management +</a>
	...
	<script>
		...
		function displayTrainingData(data) {
			...
			for (var i = 0; i < trainings.length; i++) {
				...
				row.append("<td >" + training.management_code + "</td>");
		...
		function deleteTraining(button, management_code) {
			...
			if (isConfirmed) {
				...
				$.ajax({
					type : "Delete",
					url : "/api/delete/management/" + management_code,
		...
		function editTraining(management_code) {
			...
			if (isConfirmed) {
				...
				var editUrl = "/EditTrainingManagement.jsp?management_code="
						+ management_code;
