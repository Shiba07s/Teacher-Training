...
<script>
	...
	function saveGroupData(group_id) {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/updateTrainingGroup/" + group_id,
			data : {
			...
			success : function(response) {
				...
				window.location.href = "${pageContext.request.contextPath}/TrainingGroup.jsp";
	...
	function editGroup(group_id) {
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/getbygroupid/" + group_id,
