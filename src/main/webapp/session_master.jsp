...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewSession.jsp" class="btn btn-success mt-2">Add New
		Session +</a>
	...
	<script>
		...
		function deleteTraining(button, id) {
			...
			if (isConfirmed) {
				...
				$.ajax({
					type : "Delete",
					url : "${pageContext.request.contextPath}/api/session/deleteSession/" + id,
		...
		function editTraining(id) {
			...
			if (isConfirmed) {
				...
				var editUrl = "${pageContext.request.contextPath}/EditTrainingSession.jsp?id=" + id;
