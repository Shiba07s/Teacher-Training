...
<title>Add Training Agency</title>
...
<body>
	<form id="addSessionForm" onsubmit="return saveGroup()">
		...
		<div class="container">
			<h2>Add Training Agency</h2>

			<div>
				<label for="agency"> Agency Name:</label> <input type="text"
					id="agency" placeholder="Enter Angency name" required>
			...
			window.saveGroup = function() {
				...
				$.ajax({
					...
					success : function(response) {
						...
						toastr.success("Agency saved successfully");
						setTimeout(function() {
