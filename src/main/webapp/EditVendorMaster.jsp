...
<script>
	...
	function editVendor() {
		...
		if (venueId) {
			$
					.ajax({
						type : "GET",
						url : "${pageContext.request.contextPath}/api/vender/getbyid/" + venueId, // Replace with your actual endpoint
						dataType : "json",
	...
	function closeForm() {
		window.location.href = "${pageContext.request.contextPath}/VendorMaster.jsp";
	}
	function updateVendor() {
		if (validateForm()) {
			...
			$.ajax({
				type : "PUT",
				url : "${pageContext.request.contextPath}/api/vender/updatebyid/" + modifiedUid,
