...
<body>
	...
	<a href="/AddNewVenue.jsp" class="btn btn-success mt-2">Add New
		Venue +</a>
	...
	<script>
		...
		function editTraining(id) {
			...
			if (isConfirmed) {
				...
				var editUrl = "/EditVenue.jsp?vid=" + id;// Redirect to the EditTraining.jsp page with the query string parameters
