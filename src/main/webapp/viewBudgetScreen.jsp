...
<a href="/budgetmapping.jsp" class="btn btn-success mt-2">Add
		New Budget +</a>
...
<!--                 </div> -->
    ...
    <script>
        ...
        function editTraining(slno) {
            ...
            var editUrl = '/editbudgetmapping.jsp?slno=' + encodeURIComponent(slno);
        ...
        function approveTraining() {
            ...
            $.ajax({
                type: "POST",
                url: "/api/mapping/approve/" + trainingId + "/" + venueId,
