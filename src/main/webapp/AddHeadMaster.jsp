...
<body>
	...
	<div class="container" align="center">
		<h1 class="text-center">Add New Head</h1>
		<form id="myForm" class="text-left" onsubmit="return submitForm()">
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label for="resources">TC Code</label> <input type="text"
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="tcnames">TC Names:</label> <input
							type="text" id="tcnames" class="form-control"
	...
	<script>
		function addHeadData() {
			...
			$.ajax({
				type : "POST",
				url : "${pageContext.request.contextPath}/api/head/save",
				...
				success : function(response) {
					...
					window.location.href = "/HeadMaster.jsp";
				},
