...
<script>
	...
	function addModeData() {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/updateTrainingMode/" + modifiedUid,
			data : {
			...
			success : function(response) {
				...
				window.location.href = "${pageContext.request.contextPath}/TrainingMode.jsp";
	...
	function editTrainingMode(trainingModecode) {
		...
		$.ajax({
			...
			url : "${pageContext.request.contextPath}/api/getTrainingModeCodeByid/" + trainingModecode,
