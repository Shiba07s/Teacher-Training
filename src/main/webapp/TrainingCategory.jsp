...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewCategory.jsp" class="btn btn-success mt-2">Add
	...
	<script>
		...
		// Sample functions for edit and delete
		function deleteTraining(button, uid) {
			...
			if (isConfirmed) {
				...
				$.ajax({
					type : "Delete",
					url : "${pageContext.request.contextPath}/api/delete/" + uid,
		...
		function editTraining(uid) {
			...
			if (isConfirmed) {
				...
				var editUrl = "${pageContext.request.contextPath}/EditTraining.jsp?uid=" + uid;
