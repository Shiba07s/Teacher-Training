	...
	<script>
		...
		function editSession(id) {
			...
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/api/session/getbysessionid/" + id,
		...
		function addEditData() {
			...
			$.ajax({
				...
				url : "${pageContext.request.contextPath}/api/session/updateSession/" + id,
				contentType : "application/json",
				data : JSON.stringify(modifiedData),
				success : function(response) {
					console.log("Training session updated successfully");
					alert("Training session updated successfully");
					window.location.href = "${pageContext.request.contextPath}/session_master.jsp";
