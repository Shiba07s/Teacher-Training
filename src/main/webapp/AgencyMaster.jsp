...
<body>
	...
	<a href="${pageContext.request.contextPath}/AddNewAgency.jsp" class="btn btn-success mt-2">Add
		New Agency +</a>
	...
	<script>
		...
		function deleteTraining(button,slno) {
			...
			$.ajax({
				type : "Delete",
				url : "${pageContext.request.contextPath}/api/agency/delete/" + slno,
		...
		function editTraining(slno) {
		    ...
		    var editUrl = "${pageContext.request.contextPath}/EditAgency.jsp?slno="+slno;
