...
public class BudgetMappingController {
	...
	BudgetMappingService BudgetMappingServ;
	 ...
	 @PostMapping("/save/bdgtmapping")
	    public ResponseEntity<String> saveBudgetMappings(@RequestBody List<BudgetMapping>  budgetMappingList,@RequestParam  String trainingid,@RequestParam  String budgetedyear,@RequestParam String trainingname,@RequestParam String vname,@RequestParam String venueid) {
