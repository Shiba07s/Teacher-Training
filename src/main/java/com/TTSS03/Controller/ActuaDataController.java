...
public class ActuaDataController {
	...
	public List<ActualData> getTrainingById(@PathVariable String refplannerid){
	...
	public ResponseEntity<ActualData>updateOneRecord(@PathVariable String refplannerid,@RequestBody ActualData actualData){
