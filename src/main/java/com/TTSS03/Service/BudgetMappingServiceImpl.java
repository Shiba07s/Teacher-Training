...
public class BudgetMappingServiceImpl implements BudgetMappingService {
	...
	BudgetMappingRepository BudgetMappingRepo;
	 ...
	 @Override
	    public void saveBudgetMappings(List<BudgetMapping> budgetMappings, String trainingId, String budgetedYear,String trainingname,String vname,String venueid) {
