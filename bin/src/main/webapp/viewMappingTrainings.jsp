...
<body>
	...
	<a href="/TTSS03/mastermapping2.jsp" class="btn btn-success mt-2" style="background-color: #5cb85c; border-color: #5cb85c;">Create
		New Mapping +</a>
	...
	<script>
		...
		function deleteTraining(mappingcode) {
			...
			$.ajax({
				type : "Delete",
				url : "/TTSS03/api/deleteMapping/" + mappingcode,
