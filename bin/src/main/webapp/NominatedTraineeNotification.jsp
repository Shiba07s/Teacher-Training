...
<head>
    ...
    $(document).ready(function () {
        ...
        function displayTrainingData(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var applyNowButton = $("<a></a>")
                    ...
                    .click(createClickHandler(training.ref_planner_id,training.venue_id))
        ...
        function createClickHandler(refPlannerId, venueId) {
            return function () {
        ...
        function redirectToApplyPage(refPlannerId,venueId) {
            ...
            var applyPageUrl = '/TTSS03/NominatedForm.jsp' +
